...
<body>
    ...
    <div class="container2 col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
          ...
          <p id="fadd">
            دگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است، و برای شرایط فعلی تکنولوژی مورد نیاز، و کاربردهای متنوع کاربردی می ب گذشته حال و آینده، شخلاقامید داشتاده قرار گیرد.
          </p>
          <i class='fas fa-comment-dollar'></i>&nbsp;<label for="costs">هزينه های سفر : </label>
          <p id="costs">
            لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم پگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است، و برای شرایط فعلی تکنولوژی مورد نیاز، و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد، کتابهای زیادی در شصت و سه درصد گذشته حال و آینده، شناخت فراوان جامعه و متخصصان را می طلبد، تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی، و فرهنگ پیشرو در زبان فارسی ایجاد کرد، در این صورت می توان امید داشت که تمام و دشواری موجود در ارائهیرد.
          </p>
